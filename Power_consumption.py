...
if __name__ == "__main__":
    ...
    #Printing the Power Consumption of the device
    print("=======================================================================================================================================")
    print("\t \t \t \t\t \t\tPOWER CONSUMPTION")
    sleep_time1=3
    print("Loading Power consumption in {} seconds ".format(sleep_time1))
    time.sleep(sleep_time1)
    print("Battery percentage : ", battery.percent)
    print("Power plugged in : ", battery.power_plugged)

    #Printing the power consumption of each processes
    print("=======================================================================================================================================")
    print("\t \t \t \t\t \t\t  TASK MANAGER \n")
    print("Loading the processes ")
    processes = get_processes_info()
    df = construct_dataframe(processes)
    df=df.drop(['memory_usage'], axis=1)
    df=df.drop(['cpu_usage'], axis=1)

    current_date_and_time = datetime.now()
    print("The current date and time is", current_date_and_time)
    #df['create_time']=current_date_and_time

    sleep_time2=5
    print("Initiating in {} seconds...".format(sleep_time2))
    ...
    #Inputs
    print("\n\n\nEnter the pid no.")#Enter the no. as 4
    pidnum=int(input())
    print(df.loc[pidnum,:])
